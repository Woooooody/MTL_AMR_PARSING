...
def default_parameters():
    params = tf.contrib.training.HParams(
        input=["../data/amr/baselineamr/small.source.train",    # source input file
               "../data/amr/baselineamr/small.target.train",    # amr target file
               "../data/amr/syntax/"],                          # parsing target file
        output="",
        record="",
        model="transformer",
        vocab=["../data/amr/baselineamr/vocab.source.small.txt", "../data/amr/baselineamr/vocab.target.small.txt"],
        ...
        decode_alpha=0.6,
        decode_length=50,
        validation="../data/amr/baselineamr/small.source.dev",
        references=["../data/amr/baselineamr/small.target.dev"],
